...
export default function Signup() {
  ...
  return (
    <>
      <main>
        <div className="sm:pt-16 sm:w-[80%] mx-auto ">
          <div className="grid grid-cols-1 border-2 bg-white  grid-rows-2 md:grid-cols-2 md:grid-rows-1 px-9 py-16 rounded-md shadow-sm shadow-gray-500">
            <svg
            ...
            <form
              className="md:mx-0 md:ml-auto md:border-l-2 border-orange-400 md:pl-16 "
              onSubmit={handleSubmit}
            >
              <h1 className="text-xl uppercase font-medium text-center text-gray-700">
                create an account
              </h1>
              ...
              <div className="mt-4">
                <div className="relative">
                  ...
                  {type.password ? (
                    <FaEye
                      onClick={() =>
                        setType({ ...type, password: !type.password })
                      }
          ...
          disabled:bg-slate-600/40 disabled:text-blue-500/50 disabled:hover:shadow-none  font-2xl uppercase font-bold bg-orange-300 py-3 mt-8 rounded-lg text-white"
              ...
              <button
                className="my-3 justify-center bg-gray-100 border capitalize text-lg font-medium w-full py-2 hover:bg-gray-300 rounded-md text-gray-700 flex items-center"
